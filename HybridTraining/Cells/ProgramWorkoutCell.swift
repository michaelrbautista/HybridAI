...
struct ProgramWorkoutCell: View {
    var workout: Workout
    var action: (() -> Void)
...
#Preview {
    NavigationStack {
        List {
            ProgramWorkoutCell(workout: Workout(type: .EasyRun, distance: nil, minutes: 45, segments: nil, exercises: nil)) {
